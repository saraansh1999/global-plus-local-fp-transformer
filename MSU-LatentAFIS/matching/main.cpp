...
int main(int argc, char** argv)
{
    ...
    if(args.cmdOptionExists("-c")){
        ...
        cout << "Missing codebook_path" << endl;
    }
    ...
    // }
    string f1, f2;
    if(args.cmdOptionExists("-f1")){
        f1 = args.getCmdOption("-f1");
    }
    else{
        cout << "Missing f1" << endl;
    }
    if(args.cmdOptionExists("-f2")){
        f2 = args.getCmdOption("-f2");
    }
    else{
        cout << "Missing f2" << endl;
    }

    matcher.Our_Matching(f1, f2);
