...
# get patches
echo "---------------- GT extraction---------------------"
python extraction/pipeline.py --gpu 0 --input_dir /scratch/additya/DB2_A/ \
									--output_dir /scratch/additya/gt_all/ \
									--mode gt --patch_types 1,2,3

# split by patchtypes
echo "--------------------Channel Splitting-------------------------"
python split_channels.py --input_dir /scratch/additya/gt_all/ \
									--output_dir /scratch/additya/gt_channels/
...
python extraction/pipeline.py --gpu 0 --input_dir /scratch/additya/gt_all/ \
									--output_dir /scratch/additya/templates_all/ \
									--mode templates
...
python metric_extractor.py --dir /scratch/additya/templates_all/ \
									--people 140 --impressions 12 --savename db2a_all | tee results_db2a_all.txt
